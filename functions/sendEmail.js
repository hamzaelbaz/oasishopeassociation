...
exports.handler = async function (event, context) {
    try {
        ...
        const { name, messages, emails, objets, tele } = requestBody;

        console.log('Email details:', { name, messages, emails, objets, tele });
        ...
        let message = {
            ...
            to: 'info.oasishopeassociation@gmail.com',
...
Le nom : ${name} <br> *Email : ${emails} <br> telephone : ${tele} <br> Objet : ${objets} <br> Message : ${messages} <br>
</p>
